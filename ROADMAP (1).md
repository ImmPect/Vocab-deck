...
```mermaid
%%{init: {'gantt': {'rightPadding': 220, 'leftPadding': 90, 'fontSize': 13, 'barHeight': 22, 'topPadding': 50, 'sectionFontSize': 13}}}%%
gantt
    ...
    Режим EN-RU / RU-EN    :a2, after a1, 7d
    Диктант на слух        :a3, after a2, 14d

    section Доп. функции
    Интервал. повторения   :b1, after a3, 14d
    Свои списки слов       :b2, after b1, 7d
    Статистика прогресса   :b3, after b2, 7d

    section Финализация
    Полировка и деплой     :c1, after b3, 7d
    Оформление портфолио   :c2, after c1, 7d
```

*Полные названия фаз и что каждая включает — в разделе «Фазы» ниже.*
